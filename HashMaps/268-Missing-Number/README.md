...
**⚡ Notion Revision Log — Missing Number (LC 268)**
...
**Initial Thought Process**
Two approaches: Approach 1 — subtract each element from expected sum. Approach 2 — XOR all elements and range. Chose Approach 1.
...
- `n*(n+1)/2` — integer division, works correctly here since result is always whole number
- Modify sumOfRange directly instead of creating separate variable — cleaner
...
**Mistakes to Avoid, Language Related, Pattern Specific, Coding Templates, Mind Map — No new updates**
